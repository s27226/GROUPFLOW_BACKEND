...
namespace GROUPFLOW.Features.Notifications.Services;
...
public class NotificationService
{
    ...
    public async Task<int> MarkAllAsReadAsync(int userId, CancellationToken ct = default)
    {
        ...
        _logger.LogDebug("Marked {Count} notifications as read for user {UserId}", unreadNotifications.Count, userId);
